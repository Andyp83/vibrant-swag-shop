CREATE OR REPLACE FUNCTION public.search_product_families(p_category_id uuid DEFAULT NULL::uuid, p_subcategory_id uuid DEFAULT NULL::uuid, p_decoration text DEFAULT NULL::text, p_colour_terms text[] DEFAULT '{}'::text[], p_colour_mode text DEFAULT 'any'::text, p_impact boolean DEFAULT false, p_moq_max integer DEFAULT 0, p_sort text DEFAULT 'default'::text, p_limit integer DEFAULT 60, p_offset integer DEFAULT 0, p_category_ids uuid[] DEFAULT '{}'::uuid[])
 RETURNS jsonb
 LANGUAGE sql
 STABLE
